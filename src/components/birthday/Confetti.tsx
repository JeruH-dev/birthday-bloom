...
export const useConfetti = () => {
  ...
  const fireCinematicCelebration = useCallback(() => {
    // LAYER 1: Dual Corner Cannons (Heavy splash)
    confetti({
    ...
    // LAYER 2: Central Fireworks Burst (Staggered timing to feel like real pyrotechnics)
    setTimeout(() => {
      // Internal dense golden star core
      confetti({
    ...
    // LAYER 3: Slow Falling Glitter Rain (very lightweight loop to keep FPS steady)
