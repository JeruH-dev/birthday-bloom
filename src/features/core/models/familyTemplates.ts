/**
 * Birthday Bloom family template system.
 *
 * This module keeps relationship templates scalable by sharing one base
 * schema and layering relationship-specific fields on top of it.
 */
...
export type FamilyMemberCategory =
  | 'sibling'
  | 'parent'
  | 'grandparent'
  | 'relative'
...
export type BrotherProfile = BaseFamilyMemberProfile & { memberType: 'brother'; specialized: SiblingFields };
export type SisterProfile = BaseFamilyMemberProfile & { memberType: 'sister'; specialized: SiblingFields };
export type FatherProfile = BaseFamilyMemberProfile & { memberType: 'father'; specialized: ParentFields };
export type MotherProfile = BaseFamilyMemberProfile & { memberType: 'mother'; specialized: ParentFields };
export type GrandfatherProfile = BaseFamilyMemberProfile & { memberType: 'grandfather'; specialized: GrandparentFields };
export type GrandmotherProfile = BaseFamilyMemberProfile & { memberType: 'grandmother'; specialized: GrandparentFields };
export type UncleProfile = BaseFamilyMemberProfile & { memberType: 'uncle'; specialized: RelativeFields };
export type AuntProfile = BaseFamilyMemberProfile & { memberType: 'aunt'; specialized: RelativeFields };
export type CousinProfile = BaseFamilyMemberProfile & { memberType: 'cousin'; specialized: RelativeFields };
export type SonProfile = BaseFamilyMemberProfile & { memberType: 'son'; specialized: ChildFields };
export type DaughterProfile = BaseFamilyMemberProfile & { memberType: 'daughter'; specialized: ChildFields };
export type GuardianProfile = BaseFamilyMemberProfile & { memberType: 'guardian'; specialized: GuardianFields };
export type FriendProfile = BaseFamilyMemberProfile & { memberType: 'friend'; specialized: FriendFields };
export type CustomMemberProfile = BaseFamilyMemberProfile & { memberType: 'custom'; specialized: CustomMemberFields };
...
function template<TSpecialized>(
  type: FamilyMemberType,
  label: string,
  category: FamilyMemberCategory,
  description: string,
  ...
  specialized: TSpecialized,
  specializedFields: DynamicFieldDefinition[],
): FamilyTemplateDefinition<TSpecialized> {
  return {
    type,
    label,
    category,
...
export const createFamilyMemberProfile = (
  memberType: FamilyMemberType,
  fullName: string,
  dateOfBirth?: Date,
...
export const createCustomFamilyMemberTemplate = (
  typeLabel: string,
  fields: DynamicFieldDefinition[] = [],
): FamilyTemplateDefinition<CustomMemberFields> => ({
...
export const validateFamilyMemberProfile = (profile: Partial<BaseFamilyMemberProfile>): string[] => {
  ...
  if (!profile.schemaVersion) errors.push('schemaVersion is required');
  ...
  if (!profile.basicInfo?.fullName?.trim()) errors.push('basicInfo.fullName is required');
...
export const createDefaultBrotherProfile = (name: string, dob: Date): BrotherProfile =>
  createFamilyMemberProfile('brother', name, dob, {
    gender: 'male',
    specialized: { siblingRole: 'younger' },
  }) as BrotherProfile;

export const createDefaultSisterProfile = (name: string, dob: Date): SisterProfile =>
  createFamilyMemberProfile('sister', name, dob, {
    gender: 'female',
    specialized: { siblingRole: 'younger' },
  }) as SisterProfile;

export const createDefaultFatherProfile = (name: string, dob?: Date): FatherProfile =>
  createFamilyMemberProfile('father', name, dob) as FatherProfile;

export const createDefaultMotherProfile = (name: string, dob?: Date): MotherProfile =>
  createFamilyMemberProfile('mother', name, dob) as MotherProfile;

export const createDefaultGrandfatherProfile = (name: string, dob?: Date): GrandfatherProfile =>
  createFamilyMemberProfile('grandfather', name, dob) as GrandfatherProfile;

export const createDefaultGrandmotherProfile = (name: string, dob?: Date): GrandmotherProfile =>
  createFamilyMemberProfile('grandmother', name, dob) as GrandmotherProfile;

export const createDefaultUncleProfile = (name: string, dob?: Date): UncleProfile =>
  createFamilyMemberProfile('uncle', name, dob) as UncleProfile;

export const createDefaultAuntProfile = (name: string, dob?: Date): AuntProfile =>
  createFamilyMemberProfile('aunt', name, dob) as AuntProfile;

export const createDefaultCousinProfile = (name: string, dob?: Date): CousinProfile =>
  createFamilyMemberProfile('cousin', name, dob) as CousinProfile;

export const createDefaultSonProfile = (name: string, dob?: Date): SonProfile =>
  createFamilyMemberProfile('son', name, dob) as SonProfile;

export const createDefaultDaughterProfile = (name: string, dob?: Date): DaughterProfile =>
  createFamilyMemberProfile('daughter', name, dob) as DaughterProfile;

export const createDefaultGuardianProfile = (name: string, dob?: Date): GuardianProfile =>
  createFamilyMemberProfile('guardian', name, dob) as GuardianProfile;

export const createDefaultFriendProfile = (name: string, dob?: Date): FriendProfile =>
  createFamilyMemberProfile('friend', name, dob) as FriendProfile;
